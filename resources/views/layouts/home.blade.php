...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{asset('public/content/')}}/images/favicon.ico" type="image/x-icon">
			...
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					<div class="main-menu-header">
						<img class="img-radius" src="{{asset('public/content/')}}/images/user/avatar-2.jpg" alt="User-Profile-Image">
	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
				...
				<div class="m-header">
					...
					<a href="#!" class="b-brand">
						...
						<img src="{{asset('public/content/')}}/images/logo.png" alt="" class="logo">
								...
								<div class="dropdown-menu dropdown-menu-right notification">
									...
									<ul class="noti-body">
										...
										<li class="notification">
											<div class="media">
												<img class="img-radius" src="{{asset('public/content/')}}/images/user/avatar-1.jpg" alt="Generic placeholder image">
										...
										<li class="notification">
											<div class="media">
												<img class="img-radius" src="{{asset('public/content/')}}/images/user/avatar-2.jpg" alt="Generic placeholder image">
												<div class="media-body">
						...
						<li>
							<div class="dropdown drp-user">
								...
								<div class="dropdown-menu dropdown-menu-right profile-notification">
									<div class="pro-head">
										<img src="{{asset('public/content/')}}/images/user/avatar-1.jpg" class="img-radius" alt="User-Profile-Image">
										<span>John Doe</span>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="{{asset('public/content/')}}/images/user/avatar-4.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="{{asset('public/content/')}}/images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-inline-block align-middle">
                                                <img src="{{asset('public/content/')}}/images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                <div class="d-inline-block">
                                                    <h6>William Jem</h6>
                        ...
                        <div class="review-block">
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="{{asset('public/content/')}}/images/user/avatar-2.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-sm-auto p-r-0">
                                    <img src="{{asset('public/content/')}}/images/user/avatar-4.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                </div>
                                <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row m-b-20 received-chat">
                            <div class="col-auto p-r-0">
                                <img src="{{asset('public/content/')}}/images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40">
                            </div>
                            <div class="col">
                                <div class="msg">
                        ...
                        <div class="row m-b-20 send-chat">
                            ...
                            <div class="col-auto p-l-0">
                                <img src="{{asset('public/content/')}}/images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40">
                            </div>
                        </div>
                        <div class="row m-b-20 received-chat">
                            <div class="col-auto p-r-0">
                            ...
                            <div class="col">
                                <div class="msg">
                                    <p class="m-b-0">Nice to meet you!</p>
                                    <img src="{{asset('public/content/')}}/images/widget/dashborad-1.jpg" alt="">
                                    <img src="{{asset('public/content/')}}/images/widget/dashborad-3.jpg" alt="">
                                </div>
                                <p class="text-muted m-b-0"><i class="fa fa-clock-o m-r-10"></i>10:20am</p>
                            </div>
                        </div>
...
<!-- Modal -->
<!-- Apex Chart -->
<script src="{{asset('public/content/')}}/js/plugins/apexcharts.min.js"></script>
<!-- custom-chart js -->
<script src="{{asset('public/content/')}}/js/pages/dashboard-main.js"></script>
<script>
